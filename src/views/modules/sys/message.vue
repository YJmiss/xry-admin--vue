    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="type" header-align="center" align="center" width="150" label="消息类型">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.type === 1" size="small" type="warning">课程消息</el-tag>
      ...
      <el-table-column prop="course_type" header-align="center" align="center" width="150" label="课程消息类型">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.course_type === 1" size="small" type="warning">开课通知</el-tag>
          <el-tag v-else-if="scope.row.course_type === 2" size="small" type="danger">课程章节更新</el-tag>
          <el-tag v-else size="small" type="warning">其它</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="course_id" header-align="center" align="left" width="320" label="消息->课程"></el-table-column>
      <el-table-column prop="user_id" header-align="center" align="left" width="300" label="消息->讲师"></el-table-column>
      <el-table-column prop="publish_date" header-align="center" align="center" width="150" label="发布日期"></el-table-column>
      <el-table-column prop="info" header-align="center" align="center" label="具体信息"></el-table-column>
